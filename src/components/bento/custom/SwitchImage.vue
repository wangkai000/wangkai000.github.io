...
import AnimatedBackground from "~/components/normal/AnimatedBackground.vue";
...
function handleSwitch() {
    currentImgIndex.value = (currentImgIndex.value + 1) % wallpapers.length;
}
</script>
...
<template>
    <div>
        ...
        >
            <AnimatedBackground v-model="wallpapers[currentImgIndex]" />
        </div>
