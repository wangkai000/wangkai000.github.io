...
<template>
    <ShadowCard class="!p-[5px]">
        <div
            class="h-full w-full flex flex-col items-center justify-center gap-[16px]"
        >
            <div class="mx-[10px] w-full px-2">
                <span class="block text-[14px] font-bold">
                    页面过渡动画：<span class="capitalize">{{
                        currentTransitionName.slice(0, 4)
                    }}</span>
                </span>
            ...
            <div class="w-full">
                <form class="form">
                    <label class="label">
                        <input
                            :checked="currentTransitionName === 'page'"
                            value="page"
                            name="band"
                            type="radio"
                            class="input"
                    ...
                    <label class="label">
                        <input
                            :checked="currentTransitionName === 'fade'"
                            value="sw"
                            name="band"
                            type="radio"
                            class="input"
                            @change="handleChange('fade')"
                        />
                    </label>
                    <label class="label">
                        <input
                            :checked="currentTransitionName === 'translateY'"
                            value="translateY"
                            name="band"
                            type="radio"
                            class="input"
                            @change="handleChange('translateY')"
                        />
                    </label>
                </form>
            </div>
