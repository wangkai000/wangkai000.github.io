...
<template>
    <div
        class="min-w-fit min-h-fit relative text-center bg-[var(--input-primary-color)] rounded-[6px] overflow-hidden cursor-pointer select-none hover:scale-105 transition-all duration-300"
    >
        ...
        <div
            ...
            class="activated cursor-wait w-full h-full text-[#fff] absolute top-0 left-0 z-2 font-bold italic tracking-widest"
        >
            <span
                class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
            >
