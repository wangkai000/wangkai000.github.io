...
const filteredResources = computed<Resource[]>(() => {
    if (activeTags.value.length === 0) return resources;
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            >
                <a
                    :href="resource.url"
                    target="_blank"
                    class="group relative block w-full h-full rounded-2xl overflow-hidden shadow-lg border border-violet-100 dark:border-gray-700/50 transition-all duration-500 bg-gradient-to-br from-white dark:from-gray-900 via-violet-50/80 dark:via-gray-800/80 to-indigo-100/60 dark:to-gray-800"
                >
                    <!-- 装饰光斑 -->
                    <div
