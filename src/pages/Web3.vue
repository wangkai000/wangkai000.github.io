...
function initThree() {
    ...
    const glowSizes = [
        CONFIG.sunGlowSizes[0],
        CONFIG.sunGlowSizes[1],
        CONFIG.sunGlowSizes[2],
    ];
...
<template>
    <div class="web3-container fixed inset-0 overflow-hidden bg-[#0a0a1a]">
        <canvas
            ref="canvasRef"
            class="webgl-canvas absolute inset-0 w-full h-full"
        />
        <div
            class="web3-overlay absolute inset-0 flex items-center justify-center pointer-events-none"
        >
            <Transition name="toast">
                <div
                    v-if="showToast"
                    class="toast fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 px-8 py-4 bg-pink-500/90 text-white text-lg rounded-lg shadow-[0_0_40px_rgba(255,0,255,0.8)] z-[200]"
                >
                    正在开发中...
                </div>
            </Transition>
            <div class="content text-center z-[100] pointer-events-auto">
                <h1
                    class="title text-4xl md:text-5xl lg:text-6xl font-black text-white tracking-wide leading-tight mb-4"
                    style="
                        font-family:
                            &quot;Orbitron&quot;, &quot;Rajdhani&quot;,
                ...
                <p
                    class="subtitle text-base md:text-lg lg:text-xl font-medium text-white/80 tracking-widest leading-relaxed mb-8"
                    style="
                        font-family:
                            &quot;Rajdhani&quot;, &quot;Exo 2&quot;, system-ui,
                            sans-serif;
                    "
                >
                    {{
                ...
                <button
                    class="explore-btn inline-block px-12 py-4 mb-8 text-base font-semibold text-[#0a0a1a] rounded-full cursor-pointer tracking-widest transition-all duration-300 hover:scale-105"
                    style="
