...
export const books: Book[] = [
  ...
  },
  {
    ...
    author: '0xAA',
    description:
      '《WTF Solidity》是由以太坊开发者0xAA撰写的Solidity智能合约编程指南，深入讲解了Solidity语言的语法、最佳实践、安全漏洞防范等核心话题。本书通过实际案例分析，帮助读者掌握编写高效、安全的智能合约技巧，是区块链开发者的必备读物。',
  ...
  },
  {
    ...
    cover: 'https://s41.ax1x.com/2026/03/29/pe17Y40.jpg',
  },
]
